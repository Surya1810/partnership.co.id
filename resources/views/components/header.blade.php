                      ...
                      <ul class="navbar-nav">
                          ...
                          <li class="nav-item dropdown">
                              <button class="nav-link dropdown-toggle {{ request()->is('about*') ? 'active' : '' }}"
                                  type="button" data-bs-toggle="dropdown" aria-expanded="false">Info
                                  Perusahaan</button>
                          ...
                          <li class="nav-item dropdown">
                              <button class="nav-link dropdown-toggle {{ request()->is('product*') ? 'active' : '' }}"
                                  type="button" data-bs-toggle="dropdown" aria-expanded="false">Produk</button>
                              <ul class="dropdown-menu">
